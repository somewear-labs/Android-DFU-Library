...
4. Run ruby script from souvla script/github-mvn-publish.rb -u 'https://github.com/somewear-labs/Android-DFU-Library' -m lib:dfu -t X.X.X -v X.X.X (replacing X.X.X with the tagged version i.e. 2.4.4)
